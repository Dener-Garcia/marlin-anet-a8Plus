 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 50        // dag Seconds
  #define THERMAL_PROTECTION_HYSTERESIS 6     // dag Degrees Celsius
 ...
 */
   ...
   */
  #define WATCH_BED_TEMP_PERIOD                120 // dag Seconds
  #define WATCH_BED_TEMP_INCREASE               4 // dag Degrees Celsius
#endif
...
#define FAN_KICKSTART_TIME  100  // dag parte a fam ao ligar a impressora (ms)
 ...
 */
//#define FAN_MIN_PWM 50 // dag pwm fam padrao prusa mks em 80
...
#define QUICK_HOME                          // dag habilite movimento simultaneo do x e y If G28 contains XY do a diagonal move first
...
//
// #define ASSISTED_TRAMMING // dag mostra quantas voltas dar no maniplo do ponto a ser nivelado so funciona com bltouch
#if ENABLED(ASSISTED_TRAMMING)

  // Define positions for probe points.
  #define TRAMMING_POINT_XY { {  40, 40 }, { 260,  40 }, { 260, 260 }, { 40, 260 } } // dag define os pontos de calibracao na mesa de x e y
  ...
  #define ASSISTED_TRAMMING_WIZARD    // dag habilita o menu Add a Tramming Wizard to the LCD menu
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING // dag padrao dos drivers tmc2209
...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  //#define PROBE_OFFSET_WIZARD       // dag habilita menu de offset do proble Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    //#define PROBE_OFFSET_WIZARD_START_Z -4.0 // dag altura inicial do z offset bletouch ideal seria -2

    // Set a convenient position to do the calibration (probing point and nozzle/bed-distance)
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, Y_CENTER } // dag habilita menu para calcular probe do x e y 
  #endif
#endif
  ...
  #define LCD_INFO_MENU // dag adiciona menu com info sobre impressora
  ...
  #define STATUS_MESSAGE_SCROLLING // dag habilite para longas messages
...
// LCD Print Progress options
  ...
  //#define SD_DETECT_STATE HIGH // dag prusa e anet usam em false, na mks nano v3 nao precisei alterar
  ...
  #define EVENT_GCODE_SD_ABORT "G28XYE"      // dag adicionado a extrusora tambem quando abortar uma impressao G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY // dag habilitar continuar impressao em caso de queda energia
  #if ENABLED(POWER_LOSS_RECOVERY)
    #define PLR_ENABLED_DEFAULT   false // dag caso impressora fique ligando e desligando troque para true Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)
   ...
   */
  #define SDCARD_SORT_ALPHA // dag habilitado
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_USES_RAM    true  // dag habilitado Pre-allocate a static array for faster pre-sorting.
    #define SDSORT_USES_STACK  true  // dag Prefer the stack for pre-sorting to give back some SRAM. (Negated by next 2 options.)
    #define SDSORT_CACHE_NAMES true  // dag Keep sorted items in RAM longer for speedy performance. Most expensive option.
    #define SDSORT_DYNAMIC_RAM true  // dag Use dynamic allocation (within SD menus). Least expensive option. Set SDSORT_LIMIT before use!
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // dag permite nomes grandes de arquivos Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol

  #define SCROLL_LONG_FILENAMES         // dag permite ver nome completo de grandes arquivos Scroll long filenames in the SD card menu
   ...
   */
  #define USB_FLASH_DRIVE_SUPPORT // dag padrao nano v3 habilita usb port
     ...
     */
    #define USE_OTG_USB_HOST // dag talvez precise habilitar 
   ...
   */
  #define MULTI_VOLUME // dag habilita pen drive e sd card
...
//
  ...
  #define LCD_LANGUAGE_2 pt_br // dag segundo idioma
  //#define LCD_LANGUAGE_3 de
  //#define LCD_LANGUAGE_4 es
  //#define LCD_LANGUAGE_5 it
  #ifdef LCD_LANGUAGE_2
    #define LCD_LANGUAGE_AUTO_SAVE // dag Automatically save language to EEPROM on change
  #endif
#endif
 ...
 */
#define BABYSTEPPING // dag ajuste fino z com maquina imprimindo
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // dag atalho para o baby step z Double-click on the Status Screen for Z Babystepping.
...
//#define BABYSTEP_ZPROBE_OFFSET          // dag Combine M851 Z and Babystepping
 ...
 */
#define LIN_ADVANCE // dag habilita o linear advance para melhores impressoes
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  #define LIN_ADVANCE_K 0.22    // Unit: mm compression per 1mm/s extruder speed
  //#define LA_DEBUG            // If enabled, this will generate debug information output over USB.
  #define EXPERIMENTAL_SCURVE   // dag Allow S-Curve Acceleration to be used with LA.
  #define ALLOW_LOW_EJERK       // dag habilite para funcionar com linear advanced Allow a DEFAULT_EJERK value of <10. Recommended for direct drive hotends.
#endif
 ...
 */
//#define G29_RETRY_AND_RECOVER // dag caso falhe o primeiro bed level ela vai refacer novamente bltouch
#if ENABLED(G29_RETRY_AND_RECOVER)
  #define G29_MAX_RETRIES 2 // dag quantidade tentativas
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  #define MIN_CIRCLE_SEGMENTS    48   // dag padrao na cr10v3 Minimum number of segments in a complete circle
  //#define ARC_SEGMENTS_PER_SEC 50   // Use the feedrate to choose the segment length
  #define N_ARC_CORRECTION       25   // Number of interpolated segments between corrections
  #define ARC_P_CIRCLES             // dag habilitado na cr10v3 Enable the 'P' parameter to specify complete circles
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 16 // dag padrao prusa mks 32
#else
...
#define BUFSIZE 4 // dag padrao prusa mks 32
...
#define TX_BUFFER_SIZE 0 // dag padrao prusa mks 32
 ...
 */
#define EMERGENCY_PARSER // dag habilite
...
#define ADVANCED_OK // dag habilite
 ...
 */
#define ADVANCED_PAUSE_FEATURE // dag configuracao da puasa da impressao
  ...
  #define PARK_HEAD_ON_PAUSE                    // dag Park the nozzle during pause and filament change.
  #define HOME_BEFORE_FILAMENT_CHANGE           // dag habilitado cr10-v3 If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES           // dag adiciona menu de prepare Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       600        // dag (mA) RMS current. Multiply by 1.414 for peak current.
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // dag padrao da fonte All axes (override below)
   ...
   */
  #define SQUARE_WAVE_STEPPING // dag padrao habilitado na prusa
